...
void goToStart() {
    ...
    state = START;
    drawString(50, 50, "press START to begin", (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    seed = 0;
}
void start() {
    seed++;
...
void goToGame() {
    ...
    drawString(140, 5, "Score: ", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    drawString(5, 5, "You only live once!", (((0) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));

    state = GAME;
    *(volatile u16*)0x04000068 = (((4) & 15) << 12) | (0 << 11) |
                    (((2) & 7) << 8) | (2 << 6);
    *(volatile u16*)0x0400006C = (1<<15) | NOTE_E5;
}
...
void goToPause() {
    ...
    drawString(50, 50, "Pause", (((0) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    drawString(50, 70, "press SELECT to start again", (((0) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    state = PAUSE;
...
void goToWin() {
    ...
    drawString(50, 50, "You Win!", (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10));
    state = WIN;
    *(volatile u16*)0x04000068 = (((4) & 15) << 12) | (0 << 11) |
                    (((2) & 7) << 8) | (2 << 6);
...
void goToLose() {
    fillScreen((((15) & 31) | ((15) & 31) << 5 | ((15) & 31) << 10));
    drawString(50, 50, "You Lose, good luck next time", (((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10));
    state = LOSE;
}
void lose() {
    waitForVBlank();
