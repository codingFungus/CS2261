...
# 46 "main.c"
u16 flickeringColor = (((0) & 31) | (((0) & 31) << 5) | (((16) & 31) << 10));
int frameCount = 0;

void updateGame() {


    if (frameCount > 10 && flickeringColor == (((0) & 31) | (((0) & 31) << 5) | (((16) & 31) << 10))) {
        frameCount = 0;
        flickeringColor = (((0) & 31) | (((16) & 31) << 5) | (((0) & 31) << 10));


    } else if (frameCount > 10 && flickeringColor == (((0) & 31) | (((16) & 31) << 5) | (((0) & 31) << 10))) {
        frameCount = 0;
        flickeringColor = (((0) & 31) | (((0) & 31) << 5) | (((16) & 31) << 10));
